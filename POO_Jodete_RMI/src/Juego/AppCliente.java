...
public class AppCliente {
		...
		Cliente cliente1 = new Cliente("127.0.0.1", 11121, "127.0.0.1", 9084);// muestra la vista gráfica
		Cliente cliente2 = new Cliente("127.0.0.1", 11122, "127.0.0.1", 9084);// muestra la vista gráfica

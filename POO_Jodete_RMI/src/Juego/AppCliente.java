...
public class AppCliente {
		...
		Cliente cliente1 = new Cliente("127.0.0.1", 11121, "127.0.0.1", 9376);// muestra la vista gráfica
		Cliente cliente2 = new Cliente("127.0.0.1", 11122, "127.0.0.1", 9376);// muestra la vista gráfica
		Cliente cliente3 = new Cliente("127.0.0.1", 11123, "127.0.0.1", 9376);

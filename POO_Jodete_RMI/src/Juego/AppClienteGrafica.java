...
public class AppClienteGrafica {
	...
	public static void main(String[] args) {
		...
		Cliente cliente1 = new Cliente("127.0.0.1", 11121, "127.0.0.1", 9267);// muestra la vista gráfica
		Cliente cliente2 = new Cliente("127.0.0.1", 11122, "127.0.0.1", 9267);// muestra la vista gráfica

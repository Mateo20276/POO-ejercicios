...
import ar.edu.unlu.vista.VistaGraficaPrincipalSwing;

public class AppClienteGC {
	public static void main(String[] args) {
		...
		Cliente cliente1 = new Cliente("127.0.0.1", 11121, "127.0.0.1", 9448);// muestra la vista gráfica
		Cliente cliente2 = new Cliente("127.0.0.1", 11122, "127.0.0.1", 9448);// muestra la vista gráfica
		//Cliente cliente3 = new Cliente("127.0.0.1", 11123, "127.0.0.1", 9442);
		//Cliente cliente4 = new Cliente("127.0.0.1", 11124, "127.0.0.1", 9442);// muestra la vista gráfica
		try {
